...
class PrimaryLockerRobot:
    """
    A robot that manages multiple lockers for bag storage and retrieval.
    
    The robot follows a "primary" strategy - it always tries to use the first
    available locker in sequence for storage.
    ...
    def store_bag(self, content):
        """
        Store a bag in the first available locker.
